...
public class AuditoriaLoteRepositorioImpl implements IAuditoriaLoteRepositorio {
	...
	public AuditoriaLoteRepositorioImpl(IAuditoriaLoteJpaRepositorio jpaRepositorio,
			IAuditoriaLoteJpaMapper entityMapper) {
	...
	public AuditoriaLote guardar(AuditoriaLote nuevaAuditoria) {
		AuditoriaLoteEntity guardado = jpaRepositorio.save(entityMapper.toEntity(nuevaAuditoria));
