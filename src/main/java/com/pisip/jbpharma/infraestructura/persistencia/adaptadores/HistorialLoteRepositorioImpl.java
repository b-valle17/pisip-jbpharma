...
public class HistorialLoteRepositorioImpl implements IHistorialLoteRepositorio {
	...
	public HistorialLoteRepositorioImpl(IHistorialLoteJpaRepositorio jpaRepositorio,
			IHistorialLoteJpaMapper entityMapper) {
	...
	public HistorialLote guardar(HistorialLote nuevoHistorial) {
		HistorialLoteEntity guardado = jpaRepositorio.save(entityMapper.toEntity(nuevoHistorial));
