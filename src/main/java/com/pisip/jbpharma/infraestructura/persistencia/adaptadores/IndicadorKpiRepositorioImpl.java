...
public class IndicadorKpiRepositorioImpl implements IIndicadorKpiRepositorio {
	...
	public IndicadorKpiRepositorioImpl(IIndicadorKpiJpaRepositorio jpaRepositorio, IIndicadorKpiJpaMapper entityMapper) {
	...
	public IndicadorKpi guardar(IndicadorKpi nuevoIndicadorKpi) {
		IndicadorKpiEntity guardado = jpaRepositorio.save(entityMapper.toEntity(nuevoIndicadorKpi));
