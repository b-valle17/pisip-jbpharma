...
public class DictamenLoteRepositorioImpl implements IDictamenLoteRepositorio {
	...
	public DictamenLoteRepositorioImpl(IDictamenLoteJpaRepositorio jpaRepositorio, IDictamenLoteJpaMapper entityMapper) {
	...
	public DictamenLote guardar(DictamenLote nuevoDictamenLote) {
		DictamenLoteEntity guardado = jpaRepositorio.save(entityMapper.toEntity(nuevoDictamenLote));
