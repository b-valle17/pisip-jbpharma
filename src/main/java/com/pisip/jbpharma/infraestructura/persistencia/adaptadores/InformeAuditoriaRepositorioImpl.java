...
public class InformeAuditoriaRepositorioImpl implements IInformeAuditoriaRepositorio {
	...
	public InformeAuditoriaRepositorioImpl(IInformeAuditoriaJpaRepositorio jpaRepositorio,
			IInformeAuditoriaJpaMapper entityMapper) {
	...
	public InformeAuditoria guardar(InformeAuditoria nuevoInforme) {
		InformeAuditoriaEntity guardado = jpaRepositorio.save(entityMapper.toEntity(nuevoInforme));
