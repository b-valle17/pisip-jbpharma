...
public class InformeAuditoriaController {
	...
	public InformeAuditoriaController(IInformeAuditoriaUseCase informeAuditoriaUseCase, IInformeAuditoriaDtoMapper mapper) {
	...
	public InformeAuditoriaResponseDto guardar(@Valid @RequestBody InformeAuditoriaRequestDto request) {
		InformeAuditoria informeAuditoria = mapper.toDomain(request);
		return mapper.toResponseDto(informeAuditoriaUseCase.guardar(informeAuditoria));
	}
	...
	public ResponseEntity<InformeAuditoriaResponseDto> actualizar(
			@PathVariable int idInforme,
			@Valid @RequestBody InformeAuditoriaRequestDto request) {
		InformeAuditoria informeAuditoriaDatos = mapper.toDomain(request);
		InformeAuditoria informeAuditoriaActualizado = informeAuditoriaUseCase.actualizar(idInforme, informeAuditoriaDatos);
		return ResponseEntity.ok(mapper.toResponseDto(informeAuditoriaActualizado));
	}
